...
export default function CancelPage({ searchParams }: CancelPageProps) {
  ...
  const [params, setParams] = useState<CancelPageProps['searchParams']>(
        ...
        <Card isBlurred className="bg-opacity-50">
          ...
          {loading ? (
              <div className="flex flex-col items-center justify-center py-8 gap-4">
                ...
                <div className="text-default-500">Finalizing Cancellation...</div>
              </div>
            ) : error ? (
              <>
              <div className="flex justify-between items-center mb-4 px-2">
                ...
                <p className="text-sm text-danger">An error occurred while processing your cancellation.</p>
            ...
            <div className="flex flex-col justify-between items-center space-y-4 pb-4">
              ...
              <div>
                <h2 className="text-lg font-semibold pb-1 text-center">Transaction Cancelled</h2>
                <p className="text-sm text-default-500 text-center">Your deposit has been cancelled</p>
              </div>
            </div>
